...
const DAILY_CHALLENGES = [
  {
    ...
    icon: "🏆",
    name: "Daily Winner",
    desc: "Win 1 game today",
    progress: 1,
    total: 1,
    rewards: [{ type: "xp", amount: 50, icon: "⭐" }],
    completed: true,
    claimed: false,
    difficulty: "easy",
  },
  {
    ...
    icon: "🃏",
    name: "Sly Fox",
    desc: "Land a successful bluff",
    progress: 0,
    total: 1,
    rewards: [
      { type: "xp", amount: 30, icon: "⭐" },
      { type: "coins", amount: 10, icon: "🪙" },
    ],
    completed: false,
    claimed: false,
    difficulty: "easy",
  },
  {
    ...
    progress: 6,
    total: 10,
    rewards: [{ type: "xp", amount: 40, icon: "⭐" }],
    completed: false,
    claimed: false,
    difficulty: "medium",
  },
...
const WEEKLY_CHALLENGES = [
  {
    ...
    desc: "Win 5 games this week",
    progress: 3,
    total: 5,
    rewards: [
      { type: "xp", amount: 200, icon: "⭐" },
  ...
  },
  {
    ...
    icon: "🎰",
    name: "High Roller",
    desc: "Use All-In token and win",
    progress: 0,
    total: 1,
    rewards: [
      { type: "xp", amount: 150, icon: "⭐" },
      { type: "cosmetic", name: "Lucky Spray", icon: "✨" },
    ],
    completed: false,
    claimed: false,
    difficulty: "hard",
  },
  {
    ...
    icon: "👥",
    name: "Squad Up",
    desc: "Play 10 games with friends",
    progress: 10,
    total: 10,
    rewards: [
      { type: "xp", amount: 100, icon: "⭐" },
      { type: "bp", amount: 200, icon: "🎯" },
    ],
    completed: true,
    claimed: false,
    difficulty: "medium",
  },
  {
    ...
    icon: "🔥",
    name: "Unstoppable",
    desc: "Reach a 7-question streak",
    progress: 4,
    total: 7,
    rewards: [{ type: "xp", amount: 175, icon: "⭐" }],
    completed: false,
    claimed: false,
    difficulty: "hard",
  },
  {
    ...
    icon: "📅",
    name: "Daily Devotion",
    desc: "Complete all daily challenges 3 days in a row",
    progress: 2,
    total: 3,
    rewards: [
      { type: "xp", amount: 300, icon: "⭐" },
      { type: "coins", amount: 100, icon: "🪙" },
    ],
    completed: false,
    claimed: false,
    difficulty: "hard",
...
const css = `
  ...
  *, *::before, *::after { box-sizing:border-box; margin:0; padding:0; }
  ...
  @keyframes claimPop   { 0%{transform:scale(1)} 30%{transform:scale(1.3) rotate(10deg)} 60%{transform:scale(0.9)} 100%{transform:scale(1) rotate(0)} }
  ...
  .progress-track {
    height:8px; border-radius:4px; background:${C.border2};
...
function RewardChip({ reward }) {
  if (reward.type === "xp") return (
    <span style={{
      ...
      background: C.a4 + "18", color: C.a4,
      border: `1px solid ${C.a4}33`,
      borderRadius:8, padding:"3px 10px",
      fontSize:12, fontWeight:800, fontFamily:"'DM Sans',sans-serif",
    }}>⭐ {reward.amount} XP</span>
  );
  if (reward.type === "coins") return (
    <span style={{
      display:"inline-flex", alignItems:"center", gap:4,
      background: C.a2 + "18", color: C.a2,
      border: `1px solid ${C.a2}33`,
      borderRadius:8, padding:"3px 10px",
      fontSize:12, fontWeight:800, fontFamily:"'DM Sans',sans-serif",
    }}><CoinIcon size={12} /> {reward.amount}</span>
  );
  if (reward.type === "bp") return (
    <span style={{
      display:"inline-flex", alignItems:"center", gap:4,
      background: C.a5 + "18", color: C.a5,
      border: `1px solid ${C.a5}33`,
      borderRadius:8, padding:"3px 10px",
      fontSize:12, fontWeight:800, fontFamily:"'DM Sans',sans-serif",
    }}>🎯 {reward.amount} BP</span>
  );
  if (reward.type === "cosmetic") return (
    <span style={{
      display:"inline-flex", alignItems:"center", gap:4,
      background: C.a3 + "18", color: C.a3,
    ...
    <div className={`glass-card ${challenge.completed ? "completed" : ""} ${challenge.claimed ? "claimed" : ""} ${canClaim ? "shimmer-bg" : ""}`}
      ...
      <div style={{ display:"flex", alignItems:"flex-start", gap:14, marginBottom:14 }}>
        ...
        <div style={{
          ...
          background: challenge.completed
            ? `linear-gradient(135deg, ${C.a3}33, ${C.a3}11)`
        ...
        <div style={{ flex:1, minWidth:0 }}>
          <div style={{ display:"flex", justifyContent:"space-between", gap:8, alignItems:"flex-start", marginBottom:4, flexWrap:"wrap" }}>
            <h4 style={{ fontFamily:"'DM Sans',sans-serif", fontSize:15, fontWeight:800, color: challenge.claimed ? C.muted : C.text }}>
              {challenge.name}
            </h4>
            <DifficultyTag difficulty={challenge.difficulty} />
          </div>
          <p style={{ fontSize:12, color:C.muted, fontWeight:500, lineHeight:1.4 }}>
            {challenge.desc}
          </p>
        </div>
      </div>
      ...
      <div style={{ marginBottom:14, position:"relative", zIndex:1 }}>
        <div style={{ display:"flex", justifyContent:"space-between", marginBottom:6 }}>
          <span style={{ fontSize:11, color:C.muted, fontWeight:700, letterSpacing:0.5, textTransform:"uppercase" }}>
            Progress
          </span>
          <span style={{ fontSize:12, color: challenge.completed ? C.a3 : accent, fontWeight:800 }}>
        ...
        <div className="progress-track">
          <div className="progress-fill" style={{
            "--w": `${pct}%`,
            background: challenge.completed
              ? `linear-gradient(90deg, ${C.a3}, ${C.a3}cc)`
      ...
      <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center",
        ...
        {challenge.claimed ? (
          <span style={{
            ...
            background: C.border, padding:"6px 12px", borderRadius:10,
          }}>✓ Claimed</span>
        ) : canClaim ? (
          <button onClick={() => onClaim(challenge)}
            style={{
              padding:"8px 18px", borderRadius:10, border:"none",
              background: `linear-gradient(135deg, ${C.a3}, ${C.a4})`,
              color:"#fff", fontWeight:900, fontSize:13, cursor:"pointer",
              fontFamily:"'DM Sans',sans-serif",
              boxShadow:`0 4px 14px ${C.a3}55`,
...
function LoginStreak({ data, onClaimToday }) {
  return (
    <div style={{
      background: `linear-gradient(135deg, ${C.a6}18, ${C.a1}10)`,
      border: `1px solid ${C.a6}44`,
      borderRadius:20, padding:20, position:"relative", overflow:"hidden",
    }}>
      <div style={{
        position:"absolute", inset:0, opacity:0.4,
        backgroundImage:`radial-gradient(circle at 20% 20%, ${C.a6}22, transparent 50%)`,
        pointerEvents:"none",
      }} />
      <div style={{ position:"relative", zIndex:1 }}>
        <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center",
          ...
          <div style={{ display:"flex", alignItems:"center", gap:12 }}>
            ...
            <div>
              ...
              <div style={{ fontSize:12, color:C.muted, fontWeight:600 }}>
                {data.current} day{data.current !== 1 && "s"} in a row · Keep it going!
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            {data.todayClaimed ? "✓ Claimed Today" : "Claim Today's Reward"}
          </div>
        </div>
        ...
        <div style={{ display:"grid", gridTemplateColumns:"repeat(7, 1fr)", gap:6 }}>
          {data.days.map((day, i) => {
            ...
            const isPast  = day.day < data.current;
            const isLast  = day.day === 7;

            return (
              <div key={i} className="day-tile"
                style={{
                  background: day.claimed
                    ? (isLast ? `linear-gradient(135deg, ${C.a2}22, ${C.a6}18)` : C.a3 + "18")
                    : isToday
                      ? `linear-gradient(135deg, ${C.a2}22, ${C.a6}22)`
                      : isLast
                        ? `linear-gradient(135deg, ${C.a2}11, ${C.a6}08)`
                        : C.card2,
                  border: `1.5px solid ${
                    day.claimed ? (isLast ? C.a2 + "66" : C.a3 + "55") :
                    isToday ? C.a2 :
                    isLast ? C.a2 + "44" :
                    C.border2
                  }`,
                ...
                <div style={{
                  ...
                  filter: day.claimed && !isLast ? "grayscale(0.5)" : "none",
                }}>{day.reward.icon}</div>
                <div style={{
                  fontSize:11, fontWeight:800,
                  color: day.claimed ? C.muted : isLast ? C.a2 : C.text,
                }}>
                  {day.reward.amount}{day.reward.type === "box" ? "" : ""}
                </div>
                {day.claimed && (
                  <div style={{
...
function ClaimPopup({ data, onClose }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        background: C.card, border: `2px solid ${C.a3}`,
        borderRadius:24, padding:"32px 36px",
        textAlign:"center", maxWidth:380,
        animation:"popIn 0.4s cubic-bezier(.17,.67,.35,1.3)",
        boxShadow:`0 0 60px ${C.a3}33`,
        position:"relative", zIndex:2,
      }} onClick={e=>e.stopPropagation()}>
        <div style={{
          fontSize:60, marginBottom:12,
          animation:"float 2.5s ease-in-out infinite",
          filter:`drop-shadow(0 4px 12px ${C.a3}66)`,
        }}>{data.icon}</div>
        <div style={{ fontSize:11, color:C.a3, fontWeight:900, letterSpacing:1.5,
                      textTransform:"uppercase", marginBottom:6 }}>
          Challenge Complete!
        </div>
        <h2 style={{ fontFamily:"'Boogaloo',cursive", fontSize:26, color:C.text, marginBottom:14 }}>
          {data.name}
        </h2>
...
export default function App() {
  ...
  const dailyTime  = useCountdown(0);   // resets at midnight
  const weeklyTime = "5d 18h 23m";       // mocked weekly timer
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ maxWidth:900, margin:"0 auto", position:"relative", zIndex:1 }}>
          <div style={{ display:"flex", justifyContent:"space-between",
            ...
            <div>
              <div style={{
                fontSize:11, color:C.a4, fontWeight:900, letterSpacing:1.5,
                textTransform:"uppercase", marginBottom:4,
              }}>Quests & Challenges</div>
            ...
            {totalClaimable > 0 && (
              <div style={{
                ...
                <div>
                  <div style={{ fontSize:13, color:C.a3, fontWeight:900, lineHeight:1 }}>
                    {totalClaimable} Reward{totalClaimable !== 1 && "s"} Ready
                  </div>
                  <div style={{ fontSize:11, color:C.muted, fontWeight:600 }}>
                    Tap challenges to claim
                  </div>
                </div>
              </div>
            )}
          ...
          <div style={{
            ...
            <div style={{
              background:C.card2, border:`1px solid ${C.a3}44`,
              ...
              <div style={{ flex:1 }}>
                <div style={{ fontSize:11, color:C.muted, fontWeight:700,
                              letterSpacing:0.5, textTransform:"uppercase" }}>Daily</div>
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"baseline" }}>
                  <div style={{ fontFamily:"'Boogaloo',cursive", fontSize:22, color:C.text }}>
                    {dailyCompleted}/{dailies.length}
                  </div>
                  <div style={{ fontSize:11, color:C.a3, fontWeight:700 }}>
                    ⏱ Resets in {dailyTime}
                  </div>
                </div>
              </div>
            ...
            <div style={{
              background:C.card2, border:`1px solid ${C.a5}44`,
              borderRadius:14, padding:"14px 18px",
              display:"flex", alignItems:"center", gap:12,
            }}>
              <div style={{ fontSize:30 }}>📆</div>
              <div style={{ flex:1 }}>
                <div style={{ fontSize:11, color:C.muted, fontWeight:700,
                              letterSpacing:0.5, textTransform:"uppercase" }}>Weekly</div>
                <div style={{ display:"flex", justifyContent:"space-between", alignItems:"baseline" }}>
                  <div style={{ fontFamily:"'Boogaloo',cursive", fontSize:22, color:C.text }}>
                    {weeklyCompleted}/{weeklies.length}
                  </div>
                  <div style={{ fontSize:11, color:C.a5, fontWeight:700 }}>
                    ⏱ {weeklyTime}
                  </div>
                </div>
              </div>
          ...
          <div style={{ display:"flex", gap:2, borderBottom:`1px solid ${C.border}`, overflowX:"auto" }}>
            {[
              ...
              <button key={t.id}
                ...
                {t.label}
                <span style={{
                  background: tab===t.id ? C.a4 + "33" : C.border2,
                  color: tab===t.id ? C.a4 : C.muted,
                  fontSize:11, padding:"1px 7px", borderRadius:10, fontWeight:800,
                }}>{t.count}</span>
              </button>
            ))}
          </div>
      ...
      <div style={{ maxWidth:900, margin:"0 auto", padding:"24px 24px 0" }}>
        ...
        {filterDaily.length > 0 && (
          <div style={{ marginBottom:32 }}>
            <div style={{ display:"flex", justifyContent:"space-between",
              ...
              <h2 style={{ fontFamily:"'Boogaloo',cursive", fontSize:24,
                           display:"flex", alignItems:"center", gap:8 }}>
                📅 Daily Challenges
                <span style={{ fontSize:13, color:C.muted, fontWeight:600 }}>
                  {dailyCompleted}/{dailies.length} done
                </span>
              </h2>
              <div style={{ display:"flex", alignItems:"center", gap:6,
                ...
                <span style={{ fontSize:11, color:C.muted, fontWeight:700,
                               textTransform:"uppercase", letterSpacing:0.5 }}>Resets in</span>
                <span style={{ fontSize:13, color:C.a3, fontWeight:900,
            ...
            <div style={{ display:"grid",
                          ...
                          gap:14 }}>
              {filterDaily.map((c, i) => (
                <ChallengeCard key={c.id} challenge={c} accent={C.a3}
                  onClaim={handleClaim} />
              ))}
            </div>
          </div>
          ...
          <div style={{ marginBottom:32 }}>
            <div style={{ display:"flex", justifyContent:"space-between",
              ...
              <h2 style={{ fontFamily:"'Boogaloo',cursive", fontSize:24,
                ...
                📆 Weekly Challenges
                <span style={{ fontSize:13, color:C.muted, fontWeight:600 }}>
                  {weeklyCompleted}/{weeklies.length} done
                </span>
              </h2>
              <div style={{ display:"flex", alignItems:"center", gap:6,
                             background: C.card2, border:`1px solid ${C.border}`,
                             borderRadius:10, padding:"4px 12px" }}>
                <span style={{ fontSize:11, color:C.muted, fontWeight:700,
                               textTransform:"uppercase", letterSpacing:0.5 }}>Resets</span>
                <span style={{ fontSize:13, color:C.a5, fontWeight:900,
                               fontFamily:"'DM Sans',monospace" }}>
                  {weeklyTime}
                </span>
              </div>
            ...
            <div style={{ display:"grid",
                          gridTemplateColumns:"repeat(auto-fill, minmax(320px, 1fr))",
                          gap:14 }}>
              {filterWeekly.map((c, i) => (
                <ChallengeCard key={c.id} challenge={c} accent={C.a5}
                  onClaim={handleClaim} />
              ))}
            </div>
          </div>
        ...
        {filterDaily.length === 0 && filterWeekly.length === 0 && (
          <div style={{ textAlign:"center", padding:"60px 0", color:C.muted }}>
            ...
            <p style={{ fontSize:13, color:C.muted, fontWeight:600 }}>
              {tab === "completed" ? "No completed challenges yet" : "Check back later for more"}
            </p>
          </div>
        )}
        ...
        {/* Tip card */}
        <div style={{
          background: `linear-gradient(135deg, ${C.a4}11, ${C.a5}08)`,
          border:`1px solid ${C.a4}33`,
          borderRadius:16, padding:"16px 20px", marginTop:16,
          ...
          <div>
            ...
            <div style={{ fontSize:12, color:C.muted, fontWeight:500, marginTop:2 }}>
              Completing all 3 daily challenges gives you bonus battle pass XP. Hit your weekly goals for exclusive cosmetics!
            </div>
          </div>
        </div>
      </div>
