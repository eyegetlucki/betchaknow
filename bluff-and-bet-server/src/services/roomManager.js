...
// ─── CREATE ROOM ──────────────────────────────────────────────────────────────
function createRoom(hostSocketId, hostId, hostName, isPrivate = true) {
  ...
  const player = createPlayer({ id: hostId, username: hostName, color: PLAYER_COLORS[0] });
...
function joinRoom(code, socketId, playerId, playerName) {
  ...
  const player = createPlayer({ id: playerId, username: playerName, color });
